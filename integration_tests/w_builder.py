...
def build_tw_matrices(
    ...
    *,
    ...
    out.update({
        "W_in2hid_EX": init_from_mask(M_in2hid_EX),
        "W_in2hid_IN": init_from_mask(M_in2hid_IN),
        "W_in2hid_GJ": init_from_mask(M_in2hid_GJ),

        "W_hid_EX":    init_from_mask(M_hid_EX),
        "W_hid_IN":    init_from_mask(M_hid_IN),
        "W_hid_GJ":    init_from_mask(M_hid_GJ),

        "W_hid2out_EX": init_from_mask(M_hid2out_EX),
        "W_hid2out_IN": init_from_mask(M_hid2out_IN),
        "W_hid2out_GJ": init_from_mask(M_hid2out_GJ),
    })
