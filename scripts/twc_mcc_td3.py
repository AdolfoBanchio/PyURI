    ...
    for e in tqdm(range(MAX_EPISODE)):
        ...
        if (e+1) % 10 == 0:
            ...
            if eval_ret > best_ret:
                best_ret = eval_ret
                torch.save(engine.actor.state_dict(), f"models/twc_td3_actor_best_{timestamp}.pth")
...
def main():
    ...
    env.close()
    # save final models
    torch.save(td3.actor.state_dict(), f"models/twc_td3_final_{timestamp}.pth")
