...
def objective(trial: optuna.Trial):
    ...
    TAU   = trial.suggest_float("tau",   5e-3, 5e-3)
    MAX_STEPS          = trial.suggest_int("max_steps", 300_000, 300_000)
    EVAL_EVERY          = trial.suggest_int("eval_every", 5_000, 5_000)
    EVAL_EPIS           = trial.suggest_int("eval_epis", 100, 100)
    WARMUP_STEPS       = trial.suggest_int("warmup", 5_000, 5_000)
